const TRANSLATIONS = {
  es: {
    ...
    guestBadge: 'Perfil de prueba',
    guestBanner: 'Estas en modo invitado / perfil de prueba: tus compromisos y scripts se guardan en este equipo.',
  ...
  en: {
    ...
    guestBadge: 'Test profile',
    guestBanner: 'You are in guest / test profile mode: your commitments and scripts are saved on this device.',
