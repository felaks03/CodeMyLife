...
import { GAME_FREE_WINDOWS, isGameFreeTime, isYoutubeFreeTime } from '../src/shared/game-free-time';
...
test('YouTube queda libre todos los dias desde las 17:00', () => {
  assert.equal(isYoutubeFreeTime(at('2026-09-21T16:59:00')), false);
  assert.equal(isYoutubeFreeTime(at('2026-09-21T17:00:00')), true);
  assert.equal(isYoutubeFreeTime(at('2026-09-22T23:59:00')), true);
});
